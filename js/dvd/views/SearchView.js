...
define([
    'backbone',
    '../collections/DvdList',
    '../collections/StubDvdList',
    './ListView'
], function (Backbone, DvdList, StubDvdList, ListView) {
    var SearchView = Backbone.View.extend({
        initialize: function () {
            ...
            this.listView = new ListView({
                // HTML上のid="dvdListView"のタグ配下にレンダリングする
                el: "#dvdListView",
                // デフォルトのdivタグの出力は不要
                tagName: "",
